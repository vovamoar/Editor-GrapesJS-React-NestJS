...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
            ...
            <meta name="keywords" content="<?= $translate('components.index.meta.keywords') ?>" />
            ...
            <meta name="description" content="<?= $translate('components.index.meta.description') ?>">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-7 col-lg-5 mx-auto mx-lg-0 mb-5 mb-lg-0">
                <div>
                    <h2 data-key="components.index.headerText" class="mb-3 display-5 fw-bold"><?= $translate('components.index.headerText') ?></h2>
                    <p data-key="components.index.bodyText" class="lead mb-4"><?= $translate('components.index.bodyText') ?></p>
                </div>
            </div>
            <div class="col-12 col-lg-6 offset-xl-1">
                <img data-key="components.index.mainImage" class="d-block mx-auto img-fluid" src="<?= $getImage('components.index.mainImage') ?>" alt="...">
            </div>
        </div>
    </div>
</div>
